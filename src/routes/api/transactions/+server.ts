...
export const GET: RequestHandler = async ({ url, locals }) => {
	...
	const result = await gasRequest('list', 'transactions', { ...params, sheetId: locals.gaSheetId });
...
export const POST: RequestHandler = async ({ request, locals }) => {
	...
	const result = await gasRequest('create', 'transactions', { ...body, sheetId: locals.gaSheetId });
